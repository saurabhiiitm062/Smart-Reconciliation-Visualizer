                ...
                <div className="flex flex-wrap items-center gap-4 mb-4">
                    <div className="flex gap-2 border-b border-gray-200">
                        <button
                            ...
                            className={`px-4 py-2 font-semibold transition-colors ${activeTab === 'matches'
                        ...
                        <button
                            ...
                            className={`px-4 py-2 font-semibold transition-colors ${activeTab === 'mismatches'
                                    ? 'text-primary-600 border-b-2 border-primary-600'
                                    : 'text-gray-600 hover:text-gray-900'
                                }`}
                        >
                        ...
                        <button
                            ...
                            className={`px-4 py-2 font-semibold transition-colors ${activeTab === 'missing1'
                                    ? 'text-primary-600 border-b-2 border-primary-600'
                                    : 'text-gray-600 hover:text-gray-900'
                                }`}
                        >
                        ...
                        <button
                            ...
                            className={`px-4 py-2 font-semibold transition-colors ${activeTab === 'missing2'
                                    ? 'text-primary-600 border-b-2 border-primary-600'
                                    : 'text-gray-600 hover:text-gray-900'
                                }`}
                        >
